...
{
	// function getSettingsAccountList($type, $requestdata=[], $querydata=[])
	//public function getSettingsAccountAction($type, $requestdata=[], $querydata=[])
	//public function getSettingsBankList($type, $requestdata=[], $querydata=[])
	//public function getSettingsBankAction($type, $requestdata=[], $querydata=[])
	//public function getSettingsList($type, $requestdata=[], $querydata=[])
	//public function getSettingsAction($type, $requestdata=[], $querydata=[])
