...
class Index extends CC_Controller
{
	...
	{			
		$pagaedata['results'] 	  = $this->Uifsubmission_Model->getList('row', ['type' => 'all'],['id' => $uif_id]);		
		$pagaedata['emp_results'] = $this->Uifsubmission_Model->getEmployeesList('count',['type' => 'all'],['uif_id' => $uif_id]);
